...
public class EncryptionDecryption {
    public static void main(String[] args) {
        try {
//                String test = "123456789@fdj.comniha你好";
...
//                System.out.println("解密后的字符：" + des.decrypt(des.encrypt(test)));
                ...
                System.out.println("加密前的字符：" + test);
                System.out.println("加密后的字符：" + des.encrypt(a));
            String string=    des.decrypt(des.encrypt(a));
                System.out.println("解密后的字符：" + string);
              
      
          System.out.println(aTOm(string));//解密  
